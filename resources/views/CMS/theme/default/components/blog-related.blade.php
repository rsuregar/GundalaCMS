<div class="d-none d-sm-block">
    ...
    <div class="row pb-2">
        ...
        <a href="{{ route('blog', $item->slug) }}" style="text-decoration: none;">
                <img class="rounded img-fluid mb-2" style="height:100px" src="{{ $item->thumbnail != NULL ? $item->thumbnail:'https://via.placeholder.com/660x360.png' }}">
    ...
    <ul class="list-unstyled d-xl-none d-lg-none">
        ...
        <li class="media border-bottom mb-2">
            <img class="mr-3 rounded img-fluid" style="max-width: 64px; max-height: 64px" src="{{ $item->thumbnail != NULL ? $item->thumbnail:'https://via.placeholder.com/660x360.png' }}" alt="Generic placeholder image">
            <a href="{{ route('blog', $item->slug) }}" style="text-decoration: none;">
