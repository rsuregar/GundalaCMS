    ...
    <div class="row justify-content-center featurette">
      <div class="col-md-8">
        ...
        <div class="row justify-content-center">
            ...
            <a class="card post-preview lift h-100" href="{{ route('blog', $item->slug )}}"><img style="height:200px; object-fit:cover" class="card-img-top" src="{{ $item->thumbnail != NULL ? $item->thumbnail:'https://via.placeholder.com/660x360.png' }}" alt="...">
                    <div class="card-body">
