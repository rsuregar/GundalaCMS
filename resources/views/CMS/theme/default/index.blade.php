    ...
    <div class="row justify-content-center featurette">
      <div class="col-md-8">
        ...
        <div class="row justify-content-center">
            ...
            <a class="card post-preview lift h-100" href="{{ route('blog', $item->slug )}}"><img style="height:200px" class="card-img-top" src="{{ $item->thumbnail != NULL ? $item->thumbnail:'https://via.placeholder.com/660x360.png' }}" alt="...">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="post-preview-meta">
                            <img class="post-preview-meta-img" src="https://i.pravatar.cc/100">
