            ...
            <div class="card-header">{{ $title ?? env('APP_NAME') }}<span class="float-right"> <a class="btn btn-outline-secondary btn-sm" href="{{ route(Request::segment(2).'.index') }}"><i class="fas fa-arrow-left"></i> Kembali</span></a></div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            @isset($data)
                                <div class="text-right"><a href="{{ route('page', $data->slug )}}">Lihat Halaman</a></div>
                            @endisset
                        ...
                        <div class="col-md-3">
                              <div class='card card-small mb-3'>
                                ...
                                <div class='card-body p-0'>
                                    ...
                                    <li class="list-group-item px-3 pb-2">
                                        <div class="input-group">
                                            <input id="thumbnail" class="form-control" type="text" name="thumbnail" value="{{ !empty($data) ? $data->thumbnail: old('thumbnail') }}">
                                            <span class="input-group-btn ml-1">
                                                <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary text-white">
                                                  <i class="fas fa-folder-open"></i>
                                                </a>
                                            </span>
                                            <small>Paste link gambar disini atau pilih dari media</small>
                                        </div>
