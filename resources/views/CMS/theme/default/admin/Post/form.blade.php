...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">{{ $title ?? 'CMS' }} <span class="float-right"> <a class="btn btn-outline-secondary btn-sm" href="{{ route('post.index') }}"><i class="fas fa-arrow-left"></i> Kembali</span></a></div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            @isset($data)
                            ...
                            @method(!empty($data) ? 'PATCH':'POST')
                                ...
                                @isset($data)
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-text">{{ env('APP_URL').'/blog/' }}</div>
                                        </div>
